...
export const metadata: Metadata = {
  title: "Privacy Policy | Outfitted",
  description: "How Outfitted handles uploaded images, third-party processing, and contact information.",
};

export default function PrivacyPage() {
  return (
    <LegalPageShell title="Privacy Policy">
      <p>Outfitted lets users upload clothing images to generate outfit recommendations.</p>
      <p>
      ...
      <p>
        Outfitted may use basic analytics or affiliate tracking to understand product clicks and improve recommendations.
      </p>
